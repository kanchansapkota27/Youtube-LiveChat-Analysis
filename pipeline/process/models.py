...
class VideoLiveMessage(BaseDataClass):
    ...
    # message_dt comes pre-computed from JSON when deserialising in the processor
    ...
    def __post_init__(self):
        # Only compute message_dt when constructing fresh (not when deserialising from JSON)
